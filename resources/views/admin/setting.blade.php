...
@section('content')
    <main id="main" class="main">
        <div class="p-5 bg-white mb-3 rounded">
            <h3><b>Update details</b></h3>
            <br>
            <form action="{{ route('admin.update') }}" method="POST">
                @csrf
                <input type="number" value="{{ Auth::user()->id }}" hidden name="id">
                {{-- Name --}}
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Name</label>
                    <input type="text" name="name" class="form-control" id="exampleFormControlInput1"
                        placeholder="name@example.com" value="{{ Auth::user()->name ?? old('name') }}">
                    @error('name')
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="email" class="form-control" id="exampleFormControlInput1"
                        placeholder="name@example.com" value="{{ Auth::user()->email ?? old('email') }}">
                    @error('email')
                        <div class="fs-6 text-danger">{{ $message }}</div>
                    @enderror
                </div>
